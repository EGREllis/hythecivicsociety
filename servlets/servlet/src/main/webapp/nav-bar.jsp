<!-- TODO:
    1) modify "current" to match current page
    2) uniform width elements, occupying the whole top screen
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  <div class="collapse navbar-collapse" id="navbarsExampleDefault" width="100%">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="agm.html">AGM</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="guided_walks.html">Guided walks</a>
      </li>
      <li class="nav-item">
